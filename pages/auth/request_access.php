                    ...
                    <div class="w-full">
                        ...
                        <form method="post">
                            ...
                            <label class="block text-sm mb-2">
                                ...
                                <input id="name" type="text" class="block w-full p-2 bg-gray-50 border border-gray-300 rounded-md" required autocomplete="false">
                            </label>
                            <label class="block text-sm mb-2">
                                <span class="text-gray-700">Должность</span>
                                <input id="name" type="text" class="block w-full p-2 bg-gray-50 border border-gray-300 rounded-md" required autocomplete="false">
                            </label>
                            <label class="block text-sm mb-2">
                                <span class="text-gray-700">E-mail</span>
                                <input id="email" type="email" class="block w-full p-2 bg-gray-50 border border-gray-300 rounded-md" required autocomplete="false">
                            </label>
